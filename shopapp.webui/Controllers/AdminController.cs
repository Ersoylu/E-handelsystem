    ...
    public class AdminController: Controller
    {
        ...
        public IActionResult ProductCreate(ProductModel model)
        {
            if(ModelState.IsValid)
            {
                ...
                {                    
                    ...
                    {
                        Title="rekord tillagd",
                        Message="rekord tillagd",
                        AlertType="success"
                    });
        ...
        public IActionResult CategoryCreate(CategoryModel model)
        {
             if(ModelState.IsValid)
            {
                ...
                {
                    Title="rekord tillagd.",
                    Message=$"{entity.Name} Tillagd som kategori.",
                    AlertType="success"
                });             
        ...
        public async Task<IActionResult> ProductEdit(ProductModel model,int[] categoryIds,IFormFile file)
        {
            ...
            {        
                ...
                {                    
                     TempData.Put("message", new AlertMessage()
                    {
                        Title="rekord uppdaterat",
                        Message="rekord uppdaterat",
                        AlertType="success"
                    });  
                    return RedirectToAction("ProductList");
                }
        ...
        public async Task<IActionResult> CategoryEdit(CategoryModel model)
        {
            if(ModelState.IsValid)
            {
                ...
                {            
                    Message = $"{entity.Name} kategorin har uppdaterats.",
                    AlertType = "success"
                };
        ...
        public async Task<IActionResult> DeleteProduct(int productId)
        {
            ...
            if(entity!=null)
            {
              ...
              var msg = new AlertMessage()
            {            
                Message = $"{entity.Name} produkten har tagits bort.",
                AlertType = "danger"
            };
        ...
        public async Task<IActionResult> DeleteCategory(int categoryId)
        {
            ...
            if(entity!=null)
            {
              ...
              var msg = new AlertMessage()
            {            
                Message = $"{entity.Name} kategori har tagits bort.",
                AlertType = "danger"
            };
