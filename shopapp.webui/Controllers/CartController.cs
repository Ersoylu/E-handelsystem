...
namespace shopapp.webui.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        private Payment PaymentProcess(OrderModel model)
        {
            ...
            buyer.GsmNumber = "+467602343";
            buyer.Email = "email@email.com";
            buyer.IdentityNumber = "74300864791";
            buyer.LastLoginDate = "2015-10-05 12:43:35";
            buyer.RegistrationDate = "2013-04-21 15:12:09";
            buyer.RegistrationAddress = "Bomhus Gävle, Porfyrvägen 30";
            ...
            shippingAddress.ContactName = "Emil Bolsson";
            shippingAddress.City = "Stockholm";
            shippingAddress.Country = "Sweden";
            shippingAddress.Description = "Bomhus Stockholm, Porfyrvägen 30";
            shippingAddress.ZipCode = "80630";
            request.ShippingAddress = shippingAddress;

            Address billingAddress = new Address();
            billingAddress.ContactName = "Jane Doe";
            billingAddress.City = "Uppsala";
            billingAddress.Country = "Sweden";
            billingAddress.Description = "Bomhus Uppsala, Porfyrvägen 30";
            billingAddress.ZipCode = "80630";
