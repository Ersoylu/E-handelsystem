    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder builder) 
        {
            ...
            builder.Entity<Category>().HasData(
                ...
                new Category(){CategoryId=2,Name="Dator",Url="dator"},
                new Category(){CategoryId=3,Name="Elektronisk",Url="elektronisk"},
                new Category(){CategoryId=4,Name="Hushållsprodukter",Url="hushallsprodukter"}
            );
